...
embedding-based vendor matching, and adaptive threshold selection \cite{asai2023,yang2024,ranaldi2025}.
...
X. Wang, W. Chen, Y. Liu, and M. Zhang,
``MAIN-RAG: Multi-Agent Intelligent Retrieval-Augmented Generation for Software Engineering Tasks,''
\textit{arXiv preprint}, 2024.

\bibitem{nguyen2025marag}
T. Nguyen et al.,
``MA-RAG: Multi-Agent Retrieval-Augmented Generation for Complex Question Answering,''
\textit{Proceedings of the 2025 Conference of the Association for Computational Linguistics},
pp. 1--12, 2025.
...
A. Asai et al.,
``Self-RAG: Learning to Retrieve, Generate, and Critique for Self-Improved Generation,''
\textit{The Eleventh International Conference on Learning Representations}, 2023.
...
\bibitem{asai2023}
A. Asai et al., ``Self-RAG: Learning to Retrieve, Generate, and Critique through Self-Reflection,'' \textit{arXiv preprint https://arxiv.org/abs/2310.11511}, 2023.
...
\bibitem{reuter2025}
X. Yang et al., ``Towards Reliable Retrieval in RAG Systems for Large Legal Datasets
