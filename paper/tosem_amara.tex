...
\Description{Per-question scatter of the retrieval-metric difference between
the multi-agent pipeline and the single-agent baseline, one mark per
evaluation question, sorted by that difference. Seven marks fall on the side
favouring the single-agent baseline, three sit on the zero line as ties, and
none falls on the side favouring the multi-agent pipeline.}
