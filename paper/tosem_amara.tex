...
each nonetheless performs its own retrieval against live sources, and their
candidate pools coincide on 95 of the 100 questions (their ranked top-$k$
coincide on all 100). Retrieval is not frozen for any run reported here: the
endpoints are queried live, so figures from different runs are comparable in
direction but not paired question-by-question.}
